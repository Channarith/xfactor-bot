...
class BotManager:
    ...
    MAX_BOTS = 80  # Default set is 80 bots; max allowed
...
def _get_default_bot_configs() -> list:
    ...
    configs = [
        ...
        # =========================================================================
        # ADDITIONAL BOTS (51-80) - More sectors and themes
        # =========================================================================
        # 51-55: Sector rotation & themes
        BotConfig(
            name="🏭 Industrials & Aerospace",
            description="CAT, DE, HON, LMT, RTX - industrials and defense",
            instrument_type=InstrumentType.STOCK,
            symbols=["CAT", "DE", "HON", "LMT", "RTX", "GE", "BA", "UPS"],
            strategies=["Technical", "TrendFollowing", "Momentum"],
            strategy_weights={"Technical": 0.6, "TrendFollowing": 0.7, "Momentum": 0.5},
            max_position_size=25000,
            max_positions=5,
            buy_signal_threshold=moderate["buy_signal_threshold"],
            strong_buy_threshold=moderate["strong_buy_threshold"],
        ...
        BotConfig(
            ...
            description="JNJ, UNH, PFE, MRNA, BIIB - healthcare and biotech",
            instrument_type=InstrumentType.STOCK,
            symbols=["JNJ", "UNH", "PFE", "MRNA", "BIIB", "AMGN", "GILD", "REGN"],
            strategies=["Technical", "Momentum", "NewsSentiment"],
            strategy_weights={"Technical": 0.6, "Momentum": 0.6, "NewsSentiment": 0.7},
            max_position_size=20000,
            max_positions=5,
            enable_news_trading=True,
            buy_signal_threshold=news_driven["buy_signal_threshold"],
        ...
        BotConfig(
            ...
            description="AMZN, HD, MCD, NKE, SBUX - consumer spending plays",
            instrument_type=InstrumentType.STOCK,
            symbols=["AMZN", "HD", "MCD", "NKE", "SBUX", "LOW", "TJX", "ORLY"],
            strategies=["Technical", "Momentum", "MeanReversion"],
            strategy_weights={"Technical": 0.6, "Momentum": 0.6, "MeanReversion": 0.5},
            max_position_size=25000,
            max_positions=5,
            buy_signal_threshold=moderate["buy_signal_threshold"],
            strong_buy_threshold=moderate["strong_buy_threshold"],
        ...
        BotConfig(
            ...
            description="ENPH, SEDG, FSLR, RUN, NEE - solar and clean energy",
            instrument_type=InstrumentType.STOCK,
            symbols=["ENPH", "SEDG", "FSLR", "RUN", "NEE", "DQ", "CSIQ", "JKS"],
            strategies=["Momentum", "Technical", "NewsSentiment"],
            strategy_weights={"Momentum": 0.7, "Technical": 0.6, "NewsSentiment": 0.5},
            max_position_size=15000,
            max_positions=4,
            buy_signal_threshold=aggressive["buy_signal_threshold"],
            strong_buy_threshold=aggressive["strong_buy_threshold"],
        ...
        BotConfig(
            name="📡 5G & Telecom",
            description="T, VZ, TMUS, NOK, ERIC - telecom and 5G infrastructure",
            instrument_type=InstrumentType.STOCK,
            symbols=["T", "VZ", "TMUS", "NOK", "ERIC", "QCOM", "SWKS", "SKYT"],
            strategies=["Technical", "TrendFollowing", "MeanReversion"],
            strategy_weights={"Technical": 0.6, "TrendFollowing": 0.6, "MeanReversion": 0.5},
            max_position_size=20000,
            max_positions=5,
            buy_signal_threshold=moderate["buy_signal_threshold"],
            strong_buy_threshold=moderate["strong_buy_threshold"],
        ...
        # 56-60: More ETFs and thematic
        BotConfig(
            name="📈 Dividend Aristocrats",
            description="VIG, SCHD, DGRO - dividend growth ETFs",
            instrument_type=InstrumentType.STOCK,
            symbols=["VIG", "SCHD", "DGRO", "DVY", "VYM"],
            strategies=["Technical", "TrendFollowing", "MeanReversion"],
            strategy_weights={"Technical": 0.6, "TrendFollowing": 0.6, "MeanReversion": 0.5},
            max_position_size=40000,
            max_positions=5,
        ...
        BotConfig(
            name="🌐 Cloud & SaaS",
            description="CRM, NOW, SNOW, NET, DDOG - cloud and SaaS leaders",
            instrument_type=InstrumentType.STOCK,
            symbols=["CRM", "NOW", "SNOW", "NET", "DDOG", "ZS", "OKTA", "CRWD"],
            strategies=["Momentum", "Technical", "NewsSentiment"],
            strategy_weights={"Momentum": 0.7, "Technical": 0.6, "NewsSentiment": 0.5},
            max_position_size=20000,
            max_positions=5,
        ...
        BotConfig(
            name="🎮 Gaming & Esports",
            description="RBLX, U, EA, TTWO, DKNG - gaming and interactive entertainment",
            instrument_type=InstrumentType.STOCK,
            symbols=["RBLX", "U", "EA", "TTWO", "DKNG", "CHTR", "DIS", "WBD"],
            strategies=["Momentum", "Technical", "NewsSentiment"],
            strategy_weights={"Momentum": 0.7, "Technical": 0.6, "NewsSentiment": 0.6},
            max_position_size=15000,
            max_positions=4,
            enable_news_trading=True,
            buy_signal_threshold=aggressive["buy_signal_threshold"],
        ...
        BotConfig(
            ...
            description="CRSP, EDIT, NTLA, BEAM, VERV - gene editing and genomics",
            instrument_type=InstrumentType.STOCK,
            symbols=["CRSP", "EDIT", "NTLA", "BEAM", "VERV", "ILMN", "EXAS", "NSTG"],
            strategies=["Momentum", "Technical", "NewsSentiment"],
            strategy_weights={"Momentum": 0.7, "Technical": 0.5, "NewsSentiment": 0.8},
            max_position_size=10000,
            max_positions=3,
            enable_news_trading=True,
            buy_signal_threshold=ultra_aggressive["buy_signal_threshold"],
        ...
        BotConfig(
            name="🛢️ Oil & Gas Exploration",
            description="XOM, CVX, OXY, EOG, SLB - oil and gas producers and services",
            instrument_type=InstrumentType.STOCK,
            symbols=["XOM", "CVX", "OXY", "EOG", "SLB", "COP", "DVN", "HAL"],
            strategies=["Momentum", "Technical", "TrendFollowing"],
            strategy_weights={"Momentum": 0.6, "Technical": 0.6, "TrendFollowing": 0.7},
            max_position_size=25000,
            max_positions=5,
            buy_signal_threshold=moderate["buy_signal_threshold"],
            strong_buy_threshold=moderate["strong_buy_threshold"],
        ...
        # 61-65: More crypto & alts
        BotConfig(
            name="🪙 Altcoin Layer 1",
            description="SOL, AVAX, NEAR, FTM, SAND - alternative L1 and metaverse",
            instrument_type=InstrumentType.CRYPTO,
            symbols=["SOL", "AVAX", "NEAR", "FTM", "SAND", "MANA", "AXS", "IMX"],
            strategies=["Momentum", "Technical"],
            strategy_weights={"Momentum": 0.8, "Technical": 0.7},
            max_position_size=15000,
            max_positions=4,
        ...
        BotConfig(
            name="🪙 DeFi & Staking",
            description="LINK, AAVE, UNI, MKR, CRV - DeFi blue chips",
            instrument_type=InstrumentType.CRYPTO,
            symbols=["LINK", "AAVE", "UNI", "MKR", "CRV", "COMP", "SNX", "YFI"],
            strategies=["Momentum", "Technical", "MeanReversion"],
            strategy_weights={"Momentum": 0.7, "Technical": 0.6, "MeanReversion": 0.5},
        ...
        BotConfig(
            name="🌍 EM & Frontier ETFs",
            description="EEM, VWO, IEMG - emerging markets ETFs",
            instrument_type=InstrumentType.STOCK,
            symbols=["EEM", "VWO", "IEMG", "SCHE", "FLCH"],
            strategies=["Technical", "TrendFollowing", "MeanReversion"],
            strategy_weights={"Technical": 0.6, "TrendFollowing": 0.6, "MeanReversion": 0.5},
            max_position_size=30000,
            max_positions=4,
        ...
        BotConfig(
            name="📉 Inverse & Bear ETFs",
            description="SH, SDS, QID, SPXS - inverse and bear market ETFs",
            instrument_type=InstrumentType.STOCK,
            symbols=["SH", "SDS", "QID", "SPXS", "DOG"],
            strategies=["Momentum", "Technical"],
            strategy_weights={"Momentum": 0.8, "Technical": 0.7},
            max_position_size=10000,
            max_positions=3,
        ...
        BotConfig(
            name="🏦 Regional Banks",
            description="KRE, KBWB, regional bank ETFs and names",
            instrument_type=InstrumentType.STOCK,
            symbols=["KRE", "KBWB", "CFG", "KEY", "ZION", "FHN", "RF", "FITB"],
            strategies=["Technical", "MeanReversion", "Momentum"],
            strategy_weights={"Technical": 0.6, "MeanReversion": 0.6, "Momentum": 0.5},
            max_position_size=20000,
            max_positions=5,
            buy_signal_threshold=moderate["buy_signal_threshold"],
            strong_buy_threshold=moderate["strong_buy_threshold"],
        ...
        # 66-70: More themes
        BotConfig(
            name="🤖 AI & Semis Secondary",
            description="ARM, MRVL, AVGO, ASML, KLAC - semis and AI infrastructure",
            instrument_type=InstrumentType.STOCK,
            symbols=["ARM", "MRVL", "AVGO", "ASML", "KLAC", "LRCX", "AMAT", "ENTG"],
            strategies=["Momentum", "Technical", "TrendFollowing"],
            strategy_weights={"Momentum": 0.7, "Technical": 0.6, "TrendFollowing": 0.6},
            max_position_size=25000,
            max_positions=5,
            buy_signal_threshold=aggressive["buy_signal_threshold"],
            strong_buy_threshold=aggressive["strong_buy_threshold"],
        ...
        BotConfig(
            name="🚗 EV & Charging",
            description="CHPT, BLNK, EVGO, LCID, RIVN - EV and charging infrastructure",
            instrument_type=InstrumentType.STOCK,
            symbols=["CHPT", "BLNK", "EVGO", "LCID", "RIVN", "FSR", "GOEV", "NKLA"],
            strategies=["Momentum", "Technical", "NewsSentiment"],
            strategy_weights={"Momentum": 0.7, "Technical": 0.6, "NewsSentiment": 0.6},
            max_position_size=12000,
            max_positions=4,
        ...
        BotConfig(
            name="🇲🇽 Mexico & LatAm",
            description="EWW, ILF, GML - Mexico and Latin America ETFs",
            instrument_type=InstrumentType.STOCK,
            symbols=["EWW", "ILF", "GML", "BRF", "ECH"],
            strategies=["Technical", "TrendFollowing", "MeanReversion"],
            strategy_weights={"Technical": 0.6, "TrendFollowing": 0.6, "MeanReversion": 0.5},
            max_position_size=20000,
            max_positions=4,
            ...
            sell_signal_threshold=moderate["sell_signal_threshold"],
            strong_sell_threshold=moderate["strong_sell_threshold"],
            trade_frequency_seconds=360,
        ),
        BotConfig(
            name="📱 Fintech & Payments",
            description="PYPL, SQ, COIN, AFRM, NU - payments and fintech",
            instrument_type=InstrumentType.STOCK,
            symbols=["PYPL", "SQ", "COIN", "AFRM", "NU", "SOFI", "UPST", "OPEN"],
            strategies=["Momentum", "Technical", "NewsSentiment"],
            strategy_weights={"Momentum": 0.7, "Technical": 0.6, "NewsSentiment": 0.5},
            max_position_size=18000,
            max_positions=5,
            enable_news_trading=True,
            buy_signal_threshold=aggressive["buy_signal_threshold"],
            strong_buy_threshold=aggressive["strong_buy_threshold"],
        ...
        BotConfig(
            ...
            description="VNQ, XLRE, O, AMT, PLD - REITs and real estate",
            instrument_type=InstrumentType.STOCK,
            symbols=["VNQ", "XLRE", "O", "AMT", "PLD", "EQIX", "PSA", "WELL"],
            strategies=["Technical", "TrendFollowing", "MeanReversion"],
            strategy_weights={"Technical": 0.6, "TrendFollowing": 0.6, "MeanReversion": 0.5},
            max_position_size=30000,
            max_positions=5,
        ...
        # 71-75: Additional forex & commodity
        BotConfig(
            name="💱 Commodity Currencies",
            description="AUD, CAD, NZD - commodity-linked forex",
            instrument_type=InstrumentType.FOREX,
            symbols=["AUD/USD", "USD/CAD", "NZD/USD", "AUD/JPY", "CAD/JPY"],
            strategies=["Technical", "Momentum", "MeanReversion"],
            strategy_weights={"Technical": 0.6, "Momentum": 0.6, "MeanReversion": 0.5},
            max_position_size=30000,
            max_positions=4,
        ...
        BotConfig(
            ...
            description="MOO, DBA, CF, NTR, MOS - ag and fertilizer",
            instrument_type=InstrumentType.STOCK,
            symbols=["MOO", "DBA", "CF", "NTR", "MOS", "DE", "ADM", "BG"],
            strategies=["Technical", "TrendFollowing", "Momentum"],
            strategy_weights={"Technical": 0.6, "TrendFollowing": 0.6, "Momentum": 0.5},
            max_position_size=25000,
            max_positions=5,
            buy_signal_threshold=commodity_preset["buy_signal_threshold"],
            strong_buy_threshold=commodity_preset["strong_buy_threshold"],
        ...
        BotConfig(
            name="⚙️ Industrials Select",
            description="XLI, ITW, CMI, PCAR - industrial ETFs and names",
            instrument_type=InstrumentType.STOCK,
            symbols=["XLI", "ITW", "CMI", "PCAR", "EMR", "ETN", "ROK", "PH"],
            strategies=["Technical", "TrendFollowing", "MeanReversion"],
            strategy_weights={"Technical": 0.6, "TrendFollowing": 0.7, "MeanReversion": 0.5},
            max_position_size=25000,
            max_positions=5,
            buy_signal_threshold=moderate["buy_signal_threshold"],
            strong_buy_threshold=moderate["strong_buy_threshold"],
        ...
        BotConfig(
            ...
            description="ALB, LTHM, LAC, SQM, QS - lithium and battery supply chain",
            instrument_type=InstrumentType.STOCK,
            symbols=["ALB", "LTHM", "LAC", "SQM", "QS", "MP", "PLL", "LIT"],
            strategies=["Momentum", "Technical", "NewsSentiment"],
            strategy_weights={"Momentum": 0.7, "Technical": 0.6, "NewsSentiment": 0.6},
            max_position_size=15000,
            max_positions=4,
        ...
        BotConfig(
            ...
            description="NFLX, DIS, WBD, PARA, ROKU - media and streaming",
            instrument_type=InstrumentType.STOCK,
            symbols=["NFLX", "DIS", "WBD", "PARA", "ROKU", "CMCSA", "FOXA", "NWS"],
            strategies=["Momentum", "Technical", "NewsSentiment"],
            strategy_weights={"Momentum": 0.7, "Technical": 0.6, "NewsSentiment": 0.6},
            max_position_size=20000,
            max_positions=5,
        ...
        BotConfig(
            name="🪙 Meme & High Beta",
            description="High-beta and meme-adjacent names",
            instrument_type=InstrumentType.STOCK,
            symbols=["GME", "AMC", "BBBY", "SPCE", "RIVN", "LCID", "PLTR", "SOFI"],
            strategies=["Momentum", "Technical"],
            strategy_weights={"Momentum": 0.8, "Technical": 0.6},
            max_position_size=8000,
            max_positions=3,
            buy_signal_threshold=ultra_aggressive["buy_signal_threshold"],
            strong_buy_threshold=ultra_aggressive["strong_buy_threshold"],
        ...
        BotConfig(
            name="🌐 Cybersecurity",
            description="PANW, CRWD, ZS, FTNT, OKTA - cybersecurity leaders",
            instrument_type=InstrumentType.STOCK,
            symbols=["PANW", "CRWD", "ZS", "FTNT", "OKTA", "CYBR", "S", "CHKP"],
            strategies=["Momentum", "Technical", "NewsSentiment"],
            strategy_weights={"Momentum": 0.7, "Technical": 0.6, "NewsSentiment": 0.5},
            max_position_size=20000,
            max_positions=5,
        ...
        BotConfig(
            ...
            description="RSP, Invesco equal weight S&P 500",
            instrument_type=InstrumentType.STOCK,
            symbols=["RSP", "EQAL", "EUSA", "GSLC", "SPEQ"],
            strategies=["Technical", "TrendFollowing", "MeanReversion"],
            strategy_weights={"Technical": 0.6, "TrendFollowing": 0.6, "MeanReversion": 0.5},
            max_position_size=40000,
            max_positions=5,
        ...
        BotConfig(
            name="🇯🇵 Japan & Asia ex-China",
            description="EWJ, DXJ, EWT, EWY - Japan, Taiwan, Korea ETFs",
            instrument_type=InstrumentType.STOCK,
            symbols=["EWJ", "DXJ", "EWT", "EWY", "FXI", "INDA", "EWM", "EPHE"],
            strategies=["Technical", "TrendFollowing", "Momentum"],
            strategy_weights={"Technical": 0.6, "TrendFollowing": 0.6, "Momentum": 0.5},
            max_position_size=25000,
            max_positions=5,
        ...
        BotConfig(
            name="🛡️ Defense & Aerospace ETF",
            description="ITA, XAR, LMT, NOC - defense and aerospace",
            instrument_type=InstrumentType.STOCK,
            symbols=["ITA", "XAR", "LMT", "NOC", "RTX", "GD", "LHX", "TDG"],
            strategies=["Technical", "TrendFollowing", "Momentum"],
            strategy_weights={"Technical": 0.6, "TrendFollowing": 0.7, "Momentum": 0.5},
            max_position_size=25000,
            max_positions=5,
...
def get_bot_manager() -> BotManager:
    ...
    if not _initialized and _bot_manager.bot_count == 0:
        ...
        # ALWAYS create default bots first (all 80 bots should be available)
        # Bot definitions are never saved/loaded - only trade data is persisted
        logger.info("Creating default bots (all 80 bots always available)...")
    ...
    # Safeguard: if manager has 0 bots (e.g. after unexpected clear), repopulate defaults

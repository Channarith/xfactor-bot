...
const changelog = [
  {
    ...
    changes: [
      '📚 Expanded Trading Regulations Glossary',
      '',
      '• 17 new regulation terms added',
      '• Regulation T (Reg T) initial margin requirements',
      '• Settled vs Unsettled funds explained',
      '• Cash Liquidation Violation details',
      '• 90-Day Restriction penalties',
      '• Short selling: HTB, Borrow Fees, Locate requirements',
      '• Options Levels, PDT Reset options',
      '• Margin Interest, Overnight Margin, Excess Margin',
      '',
      '🔧 Bug Fixes',
